<template>
  <nav>
    <v-app-bar app clipped-left flat class="white">
      ...
      <v-toolbar-title>
        <router-link class="black--text" to="/">StudioVuetube</router-link>
      </v-toolbar-title>
        ...
        <v-card>
          <v-list class="MenuStyle">
            ...
            <v-list-item router to="/Setting">
              ...
              <v-list-item-title  >Vuetube 셋팅</v-list-item-title>
            </v-list-item>
    ...
    <v-navigation-drawer app clipped v-model="drawer">
      <v-list dense nav>
        ...
        <v-list-item router to="/VuetubeStudio/Contents">
          <v-list-item-icon>
            <v-icon>mdi-view-contents</v-icon>
          </v-list-item-icon>
    ...
    <!-- <UploadVideoMoal :openDialog="openUploadModal"
    v-on:closeDialog="closeDialogUploadVideo">
      
    </UploadVideoMoal>
    <VideoModal :openDialog="statusModal"
    :v-on:closeDialog="closeDialogVideoModal">
      
    </VideoModal> -->
    <UploadModal :openDialog="modalStatus"
      v-on:closeDialog="closeUploadModal">
...
// import UploadVideoMoal from '@/components/Modal/UploadVideoMoal.vue'
